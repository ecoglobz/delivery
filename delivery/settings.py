...
DATABASES = {
    'default': {
        ...
        'NAME': 'deliver_opav',  # Use environment variable for security
        'USER': 'deliver_opav_user',
        'PASSWORD': 'y8A7Q6qtdel7hGtdmlxuv1JpYevtrzE7',
        'HOST': 'dpg-d3v2gnbipnbc739b92bg-a.oregon-postgres.render.com',
