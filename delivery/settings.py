...
DATABASES = {
    'default': {
        ...
        'NAME': 'project_rbj1',  # Use environment variable for security
        'USER': 'project_rbj1_user',
        'PASSWORD': 'ex8LuWb2WJbaPkBZL6hIWNYhDpXYcRnY',
        'HOST': 'dpg-d24v5dh5pdvs73ca56v0-a.oregon-postgres.render.com',
